...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260617110227_AddLoanRepayments")]
    partial class AddLoanRepayments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.Admins.AdminUsers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Loans.Loan", b =>
                {
            ...
            modelBuilder.Entity("Core.Entities.Loans.LoanRepayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("RemainingBalanceBefore")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Core.Entities.Loans.Loan", b =>
                {
                    b.HasOne("Core.Entities.Admins.AdminUsers", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Core.Entities.Admins.AdminUsers", "RejectedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.Loans.LoanRepayment", b =>
                {
                    b.HasOne("Core.Entities.Loans.Loan", "Loan")
                        .WithMany("Repayments")
            ...
            modelBuilder.Entity("Core.Entities.LoanStatusHistory", b =>
                {
                    b.HasOne("Core.Entities.Admins.AdminUsers", "ChangedBy")
                        .WithMany()
